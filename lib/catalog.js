...
function parseOfficial(html,includeOutOfGame=false){
  ...
  // Do not rely on the CSS class of the table row: Fantacalcio does not use
  // exactly the same class for every active player. Any row containing a
  // valid Serie A player profile link is a candidate.
