...
function parseOfficial(html){
  ...
  for(const row of rows){
    // Fantacalcio keeps historical quotations in the table and marks players
    // who left Serie A with this element. They are not part of the active list.
...
async function enrich(p,existingRole=''){
  ...
  return{...p,name,club:clean(p.club),role,profileUrl:url};
}
